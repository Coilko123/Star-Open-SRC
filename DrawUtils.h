...
public:
	...
	static void drawGradientText(Vec2 pos, std::string* text, float textSize = 1.f, float alpha = 1.f, bool hasShadow = false);
	static void drawItemInWorld(ItemStack* item, const Vec3& location, float opacity, float scale, bool isEnchanted);
	...
	static void fillRoundRectangle(Vec4 pos, const MC_Color col, bool rounder);
	...
	static void drawRoundRectangle(Vec4 pos, const MC_Color col, bool rounder);
	static void drawText(Vec2 pos, std::string* text, MC_Color color, float textSize = 1.f, float alpha = 1.f, bool hasShadow = false, Fonts font = Fonts::SMOOTH);
	static void drawCenteredString(Vec2 pos, std::string* textStr, float textSize, MC_Color color, bool hasShadow, float alpha = 1.f);
	static void drawBox(const Vec3& lower, const Vec3& upper, float lineWidth, bool fill = false, int mode = 1, bool enableLerp = true, float lerpDuration = 1.f, float elapsedLerpTime = 0.f);
